...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static BufferedImage offscreenImage1;
    private static Graphics2D offscreen1;
    ...
    private static void init() {
        ...
        offscreenImage1 = new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB);
        onscreenImage  = new BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB);
        offscreen = offscreenImage.createGraphics();
        offscreen1 = offscreenImage1.createGraphics();
        onscreen  = onscreenImage.createGraphics();
        setXscale();
        setYscale();
        offscreen.setColor(DEFAULT_CLEAR_COLOR);
        offscreen.fillRect(0, 0, width, height);
        offscreen1.setColor(DEFAULT_CLEAR_COLOR);
        offscreen1.fillRect(0, 0, width, height);
        setPenColor();
        setPenRadius();
        setFont();
        clear();
        ...
        offscreen1.addRenderingHints(hints);
    ...
    ***************************************************************************/
    ...
    public static void point(double x, double y, int screen) {
        double xs = scaleX(x);
        double ys = scaleY(y);
        double r = penRadius;
        float scaledPenRadius = (float) (r * DEFAULT_SIZE);
		...
		if (scaledPenRadius <= 1)
			 offscreen1.fillRect((int) Math.round(scaleX(x)), (int) Math.round(scaleY(y)), 1, 1);
		else
			offscreen1.fill(new Ellipse2D.Double(xs - scaledPenRadius / 2, ys - scaledPenRadius / 2, scaledPenRadius,
					scaledPenRadius));
    }

    public static void copyOffscreen1ToOffscreen() {
    	offscreen.drawImage(offscreenImage1, 0, 0, null);
    }
